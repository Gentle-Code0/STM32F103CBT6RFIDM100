...
//System define
#define TTL_DEBUG 0 //decide whether it is using an USB-TTL device to replace an RFID module

//RFID Config
#define FIRST_RFID_UART huart1
#define SECOND_RFID_UART huart2
#define FIRST_RFID_ENABLE_PIN GPIO_PIN_15
#define RFID_PACKET_BUFFER_SIZE 100
#define RFID_FRAME_BUFFER_SIZE 50
