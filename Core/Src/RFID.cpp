...
{
    HAL_GPIO_WritePin(GPIOB, enablePin, GPIO_PIN_RESET);
}
...
void RFIDModule::reset_class_variables()
{
    ...
    for(uint8_t i = 0; i<RFID_PACKET_BUFFER_SIZE; i++)
    {
...
//TODO: Error handling needs detailing
void RFIDModule::error_handling(RFIDErrorTypes errorType)
{
    switch(errorType){
        case NotaPacket:
...
void RFIDModule::no_error_complete_handling()
{
